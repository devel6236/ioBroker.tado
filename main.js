	...
	async DoHome(HomeId){
		...
		for (const i in this.Home_data){
			...
			switch (i){
				...
				case ('isAirComfortEligible'):
					this.create_state(HomeId + '._info. ' + i, i, JSON.stringify(this.Home_data[i]));
					break;
					
				case ('isBalanceAcEligible'):
					this.create_state(HomeId + '._info. ' + i, i, JSON.stringify(this.Home_data[i]));
					break;
				...
				case ('isHeatSourceInstalled'):
					this.create_state(HomeId + '._info. ' + i, i, JSON.stringify(this.Home_data[i]));
					break;

				case ('isHeatPumpInstalled'):
					this.create_state(HomeId + '._info. ' + i, i, JSON.stringify(this.Home_data[i]));
					break;
